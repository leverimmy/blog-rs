...
`blog-rs` 是一个使用 Rust 构建的静态博客，基于 [pulldown-cmark](https://github.com/pulldown-cmark/pulldown-cmark) 渲染 Markdown，[KaTeX](https://katex.org/) 渲染 LaTeX 数学公式，[syntect](https://github.com/trishume/syntect) 代码高亮，使用 [Tera](https://keats.github.io/tera/) 作为模板引擎。
